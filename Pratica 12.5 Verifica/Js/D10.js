...
var ciao = whoIsBigger(a, b)
var ciao = a > b ? "a>b" : "b>a";
console.log(ciao)
...
return stringa.replace("4", " ");
}
nuovaStringa = stringa.replace("4", " ")
console.log(nuovaStringa)

/* ESERCIZIO 6
  Crea una funzione chiamata "isThisAnEmail" che riceve una stringa come parametro e ritorna true se la stringa è un valido indirizzo email.
*/
var stringa = "Amedeo@ronza.it";
...
function whatDayIsIt() {
  ...
  giornoGiusto = dataCorrente.getDay();
  settimana = ["Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"];
  return settimana[giornoGiusto];
}
giornoGiusto = whatDayIsIt();
console.log(giornoGiusto);
...
function isTodayMyBirthday() {
  var oggi = new Date();
  dataNascita = new Date("1992-06-29");
  if (oggi.getTime() === dataNascita.getTime()) {
    return true
  } else {return false}
}
